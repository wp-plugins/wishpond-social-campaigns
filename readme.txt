...
Wishpondâ€™s Social Contests Plugin makes it easy to build, advertise and track contests on Wordpress Sites, Facebook, Twitter  and mobile.


**New Fans, Emails & Customer Insights**
Get the results you need: Fan-Gating entices users to â€œLike to seeâ€ your contest, increasing your Facebook Fans. The customizable entry form captures emails and customer insights, like demographics and product preferences. And built-in social plugins make it easy for people to share and make your contest grow.

- Fan-Gating: Add a â€œLike to seeâ€ image to to entice users to â€œLikeâ€ your Facebook Page to enter.
...
Itâ€™s easy to customize our templates to create your perfect contest. Edit all colors, text and fonts in our CSS Editor. White-label your contest with a single click, perfect for agencies and designers. And our plugin uses responsive design to be mobile-compatible.

- CSS Editor: Add custom CSS styles to change colors, text and fonts. We can help if youâ€™re a noob.
- Mobile-Compatible: Our pluginâ€™s responsive design works on mobile to maximize entries.
- White-label: Remove all Wishpond branding and add your own. Perfect for agencies and designers.
- HTML Text Editor: Use the HTML Text Editor to add lists, link to your legal teamâ€™s â€œRules & Regulationsâ€ and more.


**Automate your Social Contests**
In minutes you can have multiple contests scheduled with automated follow-up emails to do the work for you. Real-time Reporting makes it easy to stay up-to-date and optimize contests while theyâ€™re running. You can even view results and make edits on mobile and tablet devices.

- Preview & Schedule: Preview, refine and schedule multiple campaigns in advance to automate your social marketing.
- Custom Share Messaging: Customize all of the messaging in peopleâ€™s posts, tweets and emails to friends.
...
Use Wishpondâ€™s Photo Caption Contest App to entice users to share and vote on written captions (titles) for a brandâ€™s photo to win.
...
Engage users to write about an experience theyâ€™ve had or how they would use your products and invite their friends to vote for them to win. Essay Contests have a low barrier to entry and propel users to get creative and give you great, quotable content.
...
- Collect Email Addresses: Download all entrantsâ€™ email addresses. You own them. We never email your entrants.
- Collect Entrantsâ€™ Data: Download entrantsâ€™ name, age, gender, location & Likes automatically via our integration with Facebookâ€™s Opengraph.
...
- Auto-Sharing by Entrants: Entrantâ€™s auto-share an invite with their friends on their Facebook Wall or Twitter Profile and in friendsâ€™ News Feeds.
- Satisfy Facebook Policies: Each App is built within all requirements in Facebookâ€™s Promotions Guidelines.
...
- Customizable CSS: Change every aspect of each appâ€™s CSS stylesheet to fit your brand.
...
- Like-Gate Option: You can require that users â€œLikeâ€ your Facebook Page before they can enter your contest.
...
â€œWishpondâ€™s multi-channel approach has helped us increase engagement more than any other tool we have tried in the past. We finally found a way to engage people on mobile, which is the holy grail for retailersâ€
...
â€œWishpond was simple to use, and we saw incredible results. We reached our maximum of 1000 entrants in the offer in just 2 days, and added more than 600 fans to our Facebook Page.â€
...
â€œThis has probably been the best experience in contests we have ever had. We made it easy to do and made them look forward to their next contest. It couldnâ€™t have been smoother. Thank you Wishpond!â€
...
We offer 14-days free trial on any yearly plan. Thereâ€™s no risk, no obligation. You can cancel your account at any time by simply clicking on the â€œManage Plansâ€ link on your dashboard.

= Is there a minimum commitment? =

There is no contract required for our monthly plans â€” you are billed on a monthly basis, and if you cancel you will not be billed again.
